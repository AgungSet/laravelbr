                        ...
                        <thead>
                            <tr>
                                <th class="bg-gray-50 px-6 py-3 text-left">
                                    <span class="text-xs font-medium uppercase leading-4 tracking-wider text-gray-500">Nama pesanan</span>
                                </th>
                                <th class="bg-gray-50 px-6 py-3 text-left">
                                ...
                                <th class="bg-gray-50 px-6 py-3 text-left">
                                    <span class="text-xs font-medium uppercase leading-4 tracking-wider text-gray-500">total</span>
                                </th>
                                <th class="bg-gray-50 px-6 py-3 text-left">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 divide-solid">
                            @foreach ($pesanans as $index => $pesanan)
                                <tr class="bg-white">
                                    ...
                                    <td>
                                        <img src="uploads/{{ $pesanan->foto }}" alt="{{ $pesanan->foto }}" width="100px" height="100px">
                                    </td>
                                    ...
                                    <td class="px-6 py-4 text-sm leading-5 text-gray-900 whitespace-no-wrap">
                                        ...
                                        <form action="{{ route('pesanan.destroy', $pesanan) }}" method="POST" onsubmit="return confirm('Are you sure?')" style="display: inline-block;">
                                            @csrf
                                            @method('DELETE')
